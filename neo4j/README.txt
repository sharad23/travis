...
Welcome to Neo4j release 3.0.0, a high-performance graph database.
...
For full instructions, see http://neo4j.com/docs/3.0.0/deployment.html
...
* Getting Started: http://neo4j.com/docs/3.0.0/introduction.html
* The Neo4j Manual: http://neo4j.com/docs/3.0.0/
